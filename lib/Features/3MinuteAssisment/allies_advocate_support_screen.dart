...
class AlliesAdvocateSupport extends StatefulWidget {
  AlliesAdvocateSupport({Key? key}) : super(key: key);
                ...
                child: Column(
                  children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            TitleHeading3minAssesment(
                                title: 'Recovery Oriented Peer Group'),
                            const SizedBox(height: 12),
                            const Padding(
                              padding: EdgeInsets.only(left: 14.0),
                              child: Text(
                                'ROPG (Recovery Oriented Peer Group)',
                                style: TextStyle(
                                  fontSize: 20,
                                  fontFamily: 'satoshi',
                                ...
                                return Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Checkbox(
                                        value:
                                            _selectedDomains.contains(domain),
                                        onChanged: (value) {
                                          setState(() {
                                            if (value == true) {
                    ...
                    BackAndNextButton(onBackPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => AlliesScreen()),
                      );
