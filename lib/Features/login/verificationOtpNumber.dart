...
class VerificationOTPNumber extends StatefulWidget {
  final String phoneNumber;

  const VerificationOTPNumber({
    super.key,
    required this.phoneNumber,
  });

  @override
  State<VerificationOTPNumber> createState() => _VerificationOTPNumberState();
}

class _VerificationOTPNumberState extends State<VerificationOTPNumber>
    with CodeAutoFill {
  String codeValue = "";
  late Timer _timer;
